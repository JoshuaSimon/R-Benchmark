...
main <- function() {
  ...
  print(paste0("Runtime on ", 1, " threds took ", single_time, "."))
  ...
  if (detectCores() >= 4) {
      ...
      print(paste0("Runtime on ", 4, " threds took ", multi_time, "."))
  }
  ...
  print(paste0("Runtime on ", detectCores(), " threds took ", multi_time, "."))
}
